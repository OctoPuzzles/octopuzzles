 ...
 * Definition:
 * ```sql
 * DEFINE TABLE commented SCHEMAFULL PERMISSIONS FOR select FULL, FOR create WHERE $scope = "admin", FOR update WHERE $scope = "admin", FOR delete WHERE $scope = "admin"
 * ```
*/
 ...
 * Definition:
 * ```sql
 * DEFINE TABLE environment SCHEMAFULL PERMISSIONS FOR select WHERE $scope = "admin", FOR create NONE, FOR update WHERE $scope = "admin", FOR delete NONE
 * ```
*/
export type Environment = {
     ...
     * Definition:
     * ```sql
     * DEFINE FIELD value ON environment TYPE string ASSERT $value != NONE
     * ```
    */
    value: string;
};
 ...
 * Definition:
 * ```sql
 * DEFINE TABLE label SCHEMAFULL PERMISSIONS FOR select FULL, FOR create WHERE $scope = "admin", FOR update WHERE $scope = "admin", FOR delete WHERE $scope = "admin"
 * ```
*/
export type Label = {
    /**
 ...
 * Definition:
 * ```sql
 * DEFINE TABLE sudoku SCHEMAFULL PERMISSIONS FOR select WHERE published = true OR ($scope = "user" AND id = $auth.id), FOR create WHERE $scope = "admin" OR ($scope = "user" AND user = $auth.id), FOR update WHERE $scope = "admin" OR ($scope = "user" AND user = $auth.id), FOR delete WHERE $scope = "admin" OR ($scope = "user" AND user = $auth.id)
 * ```
*/
export type Sudoku = {
    /**
    ...
    */
    borderclues?: {
         ...
         * Definition:
         * ```sql
         * DEFINE FIELD borderclues[*].color ON sudoku TYPE string ASSERT $value = NONE OR $value INSIDE ["Black", "White", "LightGray", "Gray", "Orange", "Purple", "Red", "Yellow", "Green", "Blue"]
         * ```
        */
        color?: string;
        /**
    ...
    */
    cages?: {
         ...
         * Definition:
         * ```sql
         * DEFINE FIELD cages[*].color ON sudoku TYPE string ASSERT $value = NONE OR $value INSIDE ["Black", "White", "LightGray", "Gray", "Orange", "Purple", "Red", "Yellow", "Green", "Blue"]
         * ```
        */
        color?: string;
        /**
    ...
    */
    cellclues?: {
         ...
         * Definition:
         * ```sql
         * DEFINE FIELD cellclues[*].color ON sudoku TYPE string ASSERT $value = NONE OR $value INSIDE ["Black", "White", "LightGray", "Gray", "Orange", "Purple", "Red", "Yellow", "Green", "Blue"]
         * ```
        */
        color?: string;
        /**
    ...
    */
    paths?: {
        ...
        */
         ...
         * Definition:
         * ```sql
         * DEFINE FIELD paths[*].color ON sudoku TYPE string ASSERT $value = NONE OR $value INSIDE ["Black", "White", "LightGray", "Gray", "Orange", "Purple", "Red", "Yellow", "Green", "Blue"]
         * ```
        */
        color?: string;
        /**
    ...
    */
    regions?: {
        ...
        */
         ...
         * Definition:
         * ```sql
         * DEFINE FIELD regions[*].color ON sudoku TYPE string ASSERT $value = NONE OR $value INSIDE ["Black", "White", "LightGray", "Gray", "Orange", "Purple", "Red", "Yellow", "Green", "Blue"]
         * ```
        */
        color?: string;
        /**
 ...
 * Definition:
 * ```sql
 * DEFINE TABLE user SCHEMAFULL PERMISSIONS FOR select WHERE ($scope = "user" AND id = $auth.id) OR $scope = "admin", FOR create WHERE $scope = "admin", FOR update WHERE ($scope = "user" AND id = $auth.id) OR $scope = "admin", FOR delete WHERE ($scope = "user" AND id = $auth.id) OR $scope = "admin"
 * ```
*/
export type User = {
    /**
    ...
    */
     ...
     * Definition:
     * ```sql
     * DEFINE FIELD username ON user TYPE string ASSERT $value != NONE AND $value = /^[a-zA-Z0-9]+(?:-[a-zA-Z0-9]+)*$/ AND string::length($value) <= 32
     * ```
    */
    username: string;
    /**
 ...
 * Definition:
 * ```sql
 * DEFINE TABLE vote SCHEMAFULL PERMISSIONS FOR select FULL, FOR create WHERE $scope = "admin", FOR update WHERE $scope = "admin", FOR delete WHERE $scope = "admin"
 * ```
*/
export type Vote = {
    /**
...
*/
export type TableName = "commented" | "environment" | "label" | "sudoku" | "user" | "vote";
